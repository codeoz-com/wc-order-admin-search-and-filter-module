...
class WC_Order_Admin_Search_And_Filter {
	...
	public function __construct() {
		if ( defined( 'WC_ORDER_ADMIN_SEARCH_AND_FILTER_VERSION' ) ) {
			$this->version = WC_ORDER_ADMIN_SEARCH_AND_FILTER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'coz-aosf';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-coz-aosf-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-coz-aosf-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-coz-aosf-admin.php';
